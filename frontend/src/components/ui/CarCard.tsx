    ...
    return (
        <div className="car-card">
            ...
            <div className="car-price" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span>{car.price}</span>
                <span style={{ fontSize: '0.8rem', color: '#a8b2d1', fontWeight: 500, background: 'rgba(99, 102, 241, 0.1)', border: '1px solid rgba(99, 102, 241, 0.2)', padding: '0.25rem 0.75rem', borderRadius: '1rem' }}>83.3% Precision</span>
            </div>
        </div>
    );
};
